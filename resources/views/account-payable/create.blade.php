@extends('layouts.app')
@section('title', 'Cuentas por Pagar - Crear')
@section('css')
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Crear Cuenta por Pagar</h5>
                        <a href="{{ route('account-payable.index') }}" class="btn btn-sm btn-secondary">
                            <i class="ri-arrow-left-line me-1"></i> Regresar
                        </a>
                    </div>
                    <div class="card-body">
                        <form id="formAccountPayable" class="needs-validation" action="{{ route('account-payable.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-3">
...
@section('scripts')
    ...
    <script src="{{ asset('pagesjs/account-payable/account-payable-create.js?v=2.0') }}"></script>
@endsection
