@extends('layouts.app')
@section('title', 'Cuentas por Cobrar - Crear')
@section('css')
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Crear Cuenta por Cobrar</h5>
                        <a href="{{ route('account-receivable.index') }}" class="btn btn-sm btn-secondary">
                            <i class="ri-arrow-left-line me-1"></i> Regresar
                        </a>
                    </div>
                    <div class="card-body">
                        <form id="formClub" class="needs-validation" action="{{ route('account-receivable.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-3">
                                ...
                                <div class="col-md-3 mb-3" id="supplierField" style="display: none;">
                                    <div class="form-floating form-floating-outline">
...
@section('scripts')
    ...
    <script src="{{ asset('pagesjs/account-receivable/account-receivable-create.js?v=2.0') }}"></script>
