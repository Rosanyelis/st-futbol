        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="formTask" class="needs-validation" action="{{ route('subcategory-supplier.store') }}" method="POST">
                            @csrf
                            <div class="row gy-5">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        <select class="form-control form-control-sm select2 {{ $errors->has('category_supplier_id') ? 'is-invalid' : '' }}" id="category_supplier_id" name="category_supplier_id">
                                            ...
                                            @foreach ($categorySuppliers as $categorySupplier)
                                                <option value="{{ $categorySupplier->id }}">{{ $categorySupplier->name }}</option>
                                            @endforeach
                                        </select>
