@if($canDelete)
    <a href="javascript:;" class="btn btn-sm btn-icon btn-text-secondary
        ...
        onclick="deleteEventAssignment({{ $clubId }}, {{ $eventId }})">
        <i class="ri-delete-bin-7-line ri-20px"></i>
    </a>
@else
    <span class="badge bg-warning" data-bs-toggle="tooltip" title="No se puede eliminar porque tiene cuentas por cobrar">
