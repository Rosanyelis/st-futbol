        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="formTask" class="needs-validation" action="{{ route('supplier.update', $supplier->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row gy-5">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        id="category_supplier_id" name="category_supplier_id" required>
                                            ...
                                            @foreach($categorySuppliers as $categorySupplier)
                                                <option value="{{ $categorySupplier->id }}" {{ $supplier->category_supplier_id == $categorySupplier->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-4 ">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        id="subcategory_supplier_id" name="subcategory_supplier_id" required>
                                            <option value="{{ $supplier->subcategory_supplier_id }}">{{ $supplier->subcategorySupplier->name }} </option>
                                        </select>
