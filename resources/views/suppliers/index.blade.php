    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="assignEventsModalLabel">Asignar Eventos al Proveedor</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="assignEventToSupplier()">Asignar Evento</button>
            </div>
        </div>
    </div>
</div>
...
@section('scripts')
    ...
    <!-- Page JS -->
    <script src="{{ asset('pagesjs/suppliers/index.js?v=2.0') }}"></script>
@endsection
