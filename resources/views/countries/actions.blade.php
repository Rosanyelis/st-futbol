<a href="{{ route('country.edit', $country->id) }}" class="btn btn-sm btn-icon btn-text-secondary
    rounded-pill"
    data-bs-toggle="tooltip" title="Editar País">
...
<a href="javascript:;" class="btn btn-sm btn-icon btn-text-secondary
    ...
    onclick="deleteRecord({{ $country->id }})">
