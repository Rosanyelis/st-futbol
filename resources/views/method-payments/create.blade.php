@extends('layouts.app')
@section('title', 'Metodos de Pago - Crear')
@section('css')
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="formTask" class="needs-validation" action="{{ route('method-payment.store') }}" method="POST">
                            @csrf
                            <div class="row gy-5">
                                <div class="col-md-4 ">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        id="category_method_payment_id" name="category_method_payment_id" required>
                                            ...
                                            @foreach($categoryMethodPayments as $categoryMethodPayment)
                                                <option value="{{ $categoryMethodPayment->id }}" {{ old('category_method_payment_id') == $categoryMethodPayment->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        id="type_account" name="type_account" required>
                                            ...
                                            <option value="Propia" {{ old('type_account') == 'Propia' ? 'selected' : '' }}>Propia</option>
                                            <option value="Terceros" {{ old('type_account') == 'Terceros' ? 'selected' : '' }}>Terceros</option>
                                        </select>
