@extends('layouts.app')
@section('title', 'Cambio de Monedas - Realizar Cambio')
@section('css')
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Realizar Cambio de Moneda</h5>
                        <a href="{{ route('history-change-currency.index') }}" class="btn btn-sm btn-secondary">
                            <i class="ri-arrow-left-line me-1"></i> Regresar
                        </a>
                    </div>
                    <div class="card-body">
                        <form id="formChangeCurrency" class="needs-validation" action="{{ route('history-change-currency.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row g-3">
                                <!-- Sección Origen -->
                                <div class="col-12">
                                ...
                                <div class="col-md-4 mb-3">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        id="amount" name="amount" placeholder="0" value="{{ old('amount') }}" required>
                                ...
                                <div class="col-md-3 mb-3">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        id="currency_receptor_id" name="currency_receptor_id" required>
                                            <option value="">Seleccione una moneda</option>
                                            @foreach($currencies as $currency)
                                                <option value="{{ $currency->id }}" {{ old('currency_receptor_id') == $currency->id ? 'selected' : '' }}>
                                                    {{ $currency->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-floating form-floating-outline">
                                        <input type="text" class="form-control" id="amount_converted" readonly>
...
@section('scripts')
    ...
    <script src="{{ asset('pagesjs/history-change-currency/history-change-currency-create.js?v=2.0') }}"></script>
@endsection
