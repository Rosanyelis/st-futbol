        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form id="formTask" class="needs-validation" action="{{ route('expense.update', $expense->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row gy-5">
                                    ...
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        id="category_expense_id" name="category_expense_id" required>
                                            ...
                                            @foreach($categoryExpenses as $categoryExpense)
                                                <option value="{{ $categoryExpense->id }}" {{ $expense->category_expense_id == $categoryExpense->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-12">
                                    <div class="form-floating form-floating-outline">
                                        <textarea
                                            ...
                                            cols="30" rows="10">{{ $expense->description }}</textarea>
