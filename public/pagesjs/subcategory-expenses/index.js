/**
 * Configuración avanzada de DataTables para Subcategorías de Gastos
...
document.addEventListener('DOMContentLoaded', () => {
    initSubcategoryExpensesTable();
});

/**
 * Inicializa y configura DataTable para subcategorías de gastos
 */
const initSubcategoryExpensesTable = () => {
...
/**
 * Muestra diálogo de confirmación para eliminar subcategoría de gasto
...
const deleteRecord = (id) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = `/subcategorias-gastos/${id}/destroy`;
        }
    });
};